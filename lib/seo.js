...
export function legalServiceSchema({ offices }) {
  return {
    ...
    areaServed: "Georgia",
    description:
      "Valdosta, Georgia law firm handling catastrophic injury, trucking, medical malpractice, nursing home neglect, wrongful death and serious felony defense. Practicing since 1995 with more than 200 jury trials.",
