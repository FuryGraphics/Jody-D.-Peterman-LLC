...
export const heroBadges = [
  ...
  { label: "No Fee Unless We Win", icon: "shield" },
  { label: "Free Consultation", icon: "chat" },
];
...
const parentAreas = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1518156677180-95a2893f3e9f?auto=format&fit=crop&w=1200&q=70",
    intro:
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1590247813693-5541d1c609fd?auto=format&fit=crop&w=1200&q=70",
    intro:
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "We do. Jody Peterman has tried more than 100 jury trials and prepares every case for trial — a readiness that has produced the reduction and dismissal of serious felony charges.",
      },
    ],
  },
  {
...
export const howItWorks = [
  {
    ...
    text: "Call or message us any time. We'll listen to your story, answer your questions, and explain your options — at no cost and no obligation.",
  },
  {
    step: 2,
  ...
  },
  {
    step: 4,
    title: "You Get Paid",
    text: "We pursue the full compensation you're owed. You pay nothing unless and until we win your case.",
  },
];
...
export const globalFaqs = [
  {
    ...
    a: "Nothing upfront. We handle personal injury cases on a contingency-fee basis — you pay no attorney's fee unless we recover compensation for you.",
  },
  {
  ...
  },
  {
    ...
    a: "It depends on your injuries, treatment, lost income, and the impact on your life. We'll give you an honest assessment during your free consultation.",
  },
  {
...
export const blogPosts = [
  {
    ...
    body: [
      ...
      },
      {
        ...
        p: "Before you accept any settlement, talk to a lawyer. An early offer is almost never the full value of your claim. Our consultations are free, and you pay nothing unless we win.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        p: "Evidence disappears, witnesses' memories fade, and deadlines pass quickly. The sooner you involve an attorney, the stronger your case will be. Contact us today for a free consultation.",
      },
    ],
  },
];
